         ...
         <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
            ...
            >
               ...
               <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-24">
                  <Link
                     href="/"
                     className="flex absolute top-6 left-4 sm:left-6 lg:left-8 rounded-full w-fit px-6 py-2 bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 items-center gap-2 text-white hover:text-white transition-all duration-200 hover:scale-105"
                  >
